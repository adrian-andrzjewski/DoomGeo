...
INITIAL_OUT="${OUT_DIR}/e1m1-scout-initial.png"
FIRED_OUT="${OUT_DIR}/e1m1-scout-fired.png"
...
SMOKE_BUILD_TARGET=scout-test-rom \
SMOKE_RUN_TARGET=scout-test-gngeo \
...
# The scout ROM keeps the first reachable E1M1 shotgun guy at its converted
# WAD position and starts from a normal-route waypoint, so this catches whether
# the early route can present a readable monster before the close encounter.
press_fire
sleep 0.3
