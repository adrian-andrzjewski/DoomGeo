...
def write_palette_header(path, wall_palette, wall_source, hud_palette, hud_source, ceiling_palette, ceiling_source, floor_palette, floor_source):
...
def main():
    ...
    tiles = [tile_blank(), wall_tiles[0], tile_solid()] + wall_tiles[1:] + hud_tiles + ceiling_tiles + floor_tiles + sprite_tiles
