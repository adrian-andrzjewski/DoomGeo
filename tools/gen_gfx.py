...
def main():
    ...
    ap.add_argument("--monster-sprites", default="3004:POSSA1,9:SPOSA1,3001:TROOA1,3002:SARGA1,58:SARGA1", help="Comma-separated Doom thing_type:sprite_frame pairs")
