...
WEAPON_FRAMES = ("PISGA0", "PISGB0", "PISGC0", "PISGD0", "SHTGA0", "SHTGB0", "SHTGC0", "SHTGD0")
...
def write_palette_header(path, wall_palette, wall_source, hud_palette, hud_source, ceiling_palette, ceiling_source, floor_palette, floor_source, weapon_palette, weapon_source, sprite_defs, sprite_meta, sprite_palettes):
...
def main():
    ...
    ap.add_argument("--monster-sprites", default="3004:POSSA1,9:SPOSA1,3001:TROOA1,3002:SARGA1,58:SARGA1,5:BKEYA0,6:YKEYA0,13:RKEYA0,38:RSKUA0,39:YSKUA0,40:BSKUA0,2001:SHOTA0,2007:CLIPA0,2008:SHELA0,2010:ROCKA0,2011:STIMA0,2012:MEDIA0,2014:BON1A0,2015:BON2A0,2018:ARM1A0,2019:ARM2A0,2048:BPAKA0", help="Comma-separated Doom thing_type:sprite_frame pairs")
