...
def write_palette_header(path, wall_palette, wall_source, door_palette, door_source, hud_palette, hud_source, ceiling_palette, ceiling_source, floor_palette, floor_source, weapon_palette, weapon_source, sprite_defs, sprite_meta, sprite_palettes):
