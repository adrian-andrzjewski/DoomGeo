...
SPRITE_CACHE_BASE = HUD_BASE + HUD_TILES
...
def write_palette_header(path, wall_palette, wall_source, hud_palette, hud_source):
...
def main():
    ...
    if args.palette_header:
        write_palette_header(args.palette_header, wall_palette, wall_source, hud_palette, hud_source)
    ...
    tiles = [tile_blank(), wall_tiles[0], tile_solid()] + wall_tiles[1:] + hud_tiles + sprite_tiles
